 ...
 export const NavigationButton = ({ icon: Icon, children, to, onClick, isLoading }) => (
    <div className="transition-all duration-300 font-happiness">
      {to ? (
        <Link to={to} className="flex items-center gap-3 text-gray-700 hover:text-purple-600 px-4 py-3 rounded-xl transition-all duration-300 hover:bg-white/80 font-medium group">
