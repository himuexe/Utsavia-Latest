        ...
        <nav className="relative">
          <ul className="flex justify-between px-4 ">
            {Object.entries(categories).map(([category, subCategories]) => (
              ...
              >
                <button className="font-secondary flex items-center gap-1 px-4 py-2 text-gray-800 hover:text-purple-700 transition-colors rounded-lg hover:bg-white/70 focus:outline-none focus:ring-2 focus:ring-purple-500">
                  {category}
                  <ChevronDown
