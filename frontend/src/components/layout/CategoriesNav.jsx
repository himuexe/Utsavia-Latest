        ...
        <nav className="relative">
          <ul className="flex justify-between px-4">
            {Object.entries(categories).map(([category, subCategories]) => (
              ...
              >
                <button className="font-secondary flex items-center gap-1 px-4 py-2 text-[#2D3436] hover:text-[#FF6B6B] transition-colors rounded-lg hover:bg-[#F0F0F0] focus:outline-hidden focus:ring-2 focus:ring-[#FF6B6B]">
                  {category}
                  <ChevronDown
